...
// Crear un formulario mas sencillo sin validaciones para chequear en que input se produce
// el error entre el back y el front.
...
const CreateGame = () => {
  ...
  games.forEach(game => {
    if (Array.isArray(game.platforms)) {
      game.platforms.forEach(platfs => arrSet.push(platfs))
    }
  });
