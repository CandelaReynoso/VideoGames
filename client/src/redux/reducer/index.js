...
const rootReducer = (state = initialState, action) => {
    switch(action.type) {
        ...
        case GET_GENRE:
            ...
            case GET_GAME_NAME:
                if (typeof action.payload !== 'string') {
                    return state;  // Si no es una cadena, no se hace ningún cambio
                }
            
                const searchTerm = action.payload.toLowerCase();
                const filteredGames = state.allGames.filter(game => game.name.toLowerCase().includes(searchTerm));
        ...
        case GAME_POST:
            ...
            case GAME_POST_FAILURE:
                return {
                    ...state,
                    error: action.payload // Aquí guardas el mensaje de error en el estado si ocurre un fallo
                };
        default:
            return {
                ...state,
